 ...
 * @category Form
 * @package  KFP
 * @author   Joseph Vasquez <joseph28vasquez@gmail.com>
 * @license  GPLv2 http://www.gnu.org/licenses/gpl-2.0.txt
 * @link     https://developker.com
 */
...
function Kfp_Aspirante_admin()
{
    ...
    echo '<div class="wrap"><h1>Poner el codigo en base64</h1> <br>  <label for="nombre">Nombre</label>
    <input type="text" name="nombre" id="nombre" required></div>';
